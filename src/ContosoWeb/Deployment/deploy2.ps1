...
new-azurermresourcegroupdeployment -name $Applicationname -ResourceGroupName $ResourceGroupName -templatefile ".\HybridDevops_Appservices-ASP.NET (PREVIEW)-CI/drop/deploy2.json" -TemplateParameterObject $TemplateParameterObject